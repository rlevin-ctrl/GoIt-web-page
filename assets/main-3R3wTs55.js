...
`;document.head.appendChild(U);const _=({totalPages:e,onPageChange:t,query:o})=>{const n=o.page;if(k.paginationContainer.innerHTML="",e<=1)return;const a=(l,u)=>{const m=document.createElement("button");return m.textContent=u,m.classList.add("page-button"),u===n?m.classList.add("active"):m.addEventListener("click",()=>t(u)),m},s=Math.max(1,n-2),i=Math.min(e,n+2);for(let l=s;l<=i;l+=1)k.paginationContainer.appendChild(a(o,l))},D=()=>{k.paginationContainer.innerHTML=""},v=e=>e.charAt(0).toUpperCase()+e.slice(1),A=e=>e.replace(/\s+/g,""),le=async e=>{const{data:t}=await f.get("/exercises",{params:e});return t},de=async(e,t)=>{const{data:o}=await f.patch(`/exercises/${e}/rating`,{...t});return o},ue=async e=>{const{data:t}=await f.get(`/exercises/${e}`);return t},me=async e=>{try{return await le(e)}catch(t){throw console.error("Error loading exercises by filters:",t),t}},ge=async(e,t)=>{try{const o=await de(e,t);return console.log("Rating updated successfully"),o}catch(o){throw console.error("Error updating exercise rating:",o),o}},pe=async e=>{try{return await ue(e)}catch(t){throw console.error("Error loading exercise by ID:",t),t}},fe=e=>`${Math.floor(e)}.0`;async function I(e,t){c.cardsContainer.innerHTML="",D();try{t&&(e.keyword=t),await y.show(c.cardsContainer.id);const o=await me(e);await y.hide(c.cardsContainer.id);const{page:n,perPage:a,totalPages:s,results:i}=o;if(i.length<=0){c.cardsContainer.innerHTML='<p class="not-items-message">No exercises found for this filter.</p>';return}he(i),_({totalPages:s,query:e,onPageChange:u=>{const m={...e,page:u};I(m)}})}catch{c.cardsContainer.innerHTML=""}finally{await y.hide(c.cardsContainer.id)}}const he=async e=>{F(!0);const t=e.map(ye).join("");c.cardsContainer.innerHTML=t};function ye(e){return`
  ...
  `,Ee=(e,t)=>{c.searchInput.value="",c.sectionTitle.textContent="Exercises /",c.sectionSubTitle.textContent=`${v(e)}`;const o={[A(t)]:e,page:1,limit:$};I(o)},F=e=>{const t=c.searchInput;t.style.display=e?"block":"none",e?t.addEventListener("submit",O):t.removeEventListener("submit",O)},Le=()=>{xe();const t={filter:document.querySelector(".filter-btn.active").textContent.trim(),page:1,limit:R};B(t)},xe=()=>{c.filterButtons.forEach(e=>{e.addEventListener("click",Ce)})},Ce=e=>{const t=e.target;Te(t);const n={filter:t.textContent.trim(),page:1,limit:R};B(n)},Te=e=>{c.filterButtons.forEach(t=>t.classList.remove("active")),e.classList.add("active")};function ke(e,t,o=!0){if(!t||t.length===0){e.innerHTML="";return}const n=t.map(a=>`
    <li class="workout-list-item">
      <div class="workout-card">
        <div class="workout-header">
          <span class="workout-badge">WORKOUT</span>
          ${o?`
            <button class="delete-button js-delete-button" aria-label="Delete workout" data-exercise-id=${a._id}>
              <img src="./img/trash-icon.svg" alt="Delete" width="16" height="16">
            </button>
          `:""}
          <button class="start-button" data-exercise-id=${a._id}>Start ➔</button>
        </div>
        <div class="workout-body">
